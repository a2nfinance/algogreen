...
import { getDAOProposals, getOnchainProposal, getProjectProposals } from "src/core/proposal";

export const Proposals = () => {
    const { projectProposals } = useAppSelector(state => state.proposal);
    ...
    useEffect(() => {
        if (id) {
            getProjectProposals(id.toString());
        }
